  ...
  return (
    <div className="h-full flex flex-col bg-background">
      ...
      <div className="flex-shrink-0 px-3 py-2 border-b bg-card">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h1 className="text-sm font-semibold">Loyalty Program</h1>
              <p className="text-xs text-muted-foreground">Rewards & points management</p>
            </div>
          </div>
          <Dialog open={isAddingRule || !!selectedRule} onOpenChange={(open) => {
            ...
            <DialogTrigger asChild>
              <Button size="sm" className="h-8 text-xs" onClick={() => setIsAddingRule(true)}>
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <div className="space-y-2">
                          <div className="flex items-center justify-between">
                            <span className="text-sm text-muted-foreground text-sm">{field.value} points
                            </span>
                            <Input
                              type="number"
                              className="w-20"
      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-3">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground text-sm">Available points
            </p>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground text-sm">{stats.active} active
            </p>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground text-sm">All time
            </p>
          </CardContent>
        </Card>
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground text-sm">By restaurant
            </p>
          </CardContent>
        </Card>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          {isLoading ? (
            <div className="text-center py-4">Loading loyalty rules...</div>
          ) : loyaltyRules?.length === 0 ? (
            <div className="text-center py-4 text-muted-foreground text-sm">No loyalty rules created yet
            </div>
          ) : (
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-start justify-between">
                        <div className="space-y-1 flex-1">
                          ...
                          <div className="flex items-center gap-4 text-sm text-muted-foreground text-sm"><div className="flex items-center gap-1">
                          ...
                          <div className="text-sm text-muted-foreground text-sm">{applicableDays.join(", ")}
                          </div>
                          
                          {rule.current_uses > 0 && (
                            <div className="text-sm text-muted-foreground text-sm">Used {rule.current_uses} times
      ...
      <Card>
        ...
        <CardContent>
          {transactionsLoading ? (
            ...
            <div className="text-center py-4 text-muted-foreground text-sm">No transactions yet
            </div>
          ) : (
            <div className="space-y-4">
                  ...
                  <div key={transaction.id} className="flex items-center justify-between p-4 border rounded-lg">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground text-sm">{new Date(transaction.created_at).toLocaleDateString()}
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-sm text-muted-foreground text-sm">Balance: {transaction.balance_after.toLocaleString()}
                      </p>
                    </div>
                  </div>
                )
